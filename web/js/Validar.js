/* global alertify, alerty, e, swal */

const confirmar = () => {
    const bool = confirm("Seguro de eliminar el dato?");
    if (bool) {
...
$(document).ready(function () {
    $('#enviar').submit(function (e) {
        ...
        if (usuario.length === 0) {
            ...
            ruta = "ide=" + usuario + "&nom=" + nombre + "&ape=" + apellido + "&corr=" + correo + "&dir=" + direccion + "&tel1=" + tel1 + "&tel2=" + tel2 + "&cont=" + pass;
            $.ajax({
