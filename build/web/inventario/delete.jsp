<%-- 
    Document   : delete
    Created on : 21/06/2020, 12:16:01 PM
        ...
        <section>
            <article>
                ...
                <%
                    ...
                    rs = smt.executeQuery("select * from inventario");
...
<%
    try {
        ...
        ps = con.getconexion().prepareStatement("delete from inventario where id_producto=?");
